...
class GraphBuilder:
    ...
    def setup_graph(self, usecase: str):
        ...
        if usecase == "Chatbot With Web functionality":
    ...
    def chatbot_with_tools_build_graph(self):
        ...
        #def conditional edges and direct edges
        self.graph_builder.add_edge(START, "chatbot")
